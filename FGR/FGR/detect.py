...
def generate_result(base, pickle_save_path, image_save_path, label_save_path, detect_config, save_det_image):
    ...
    try:
        ...
        for i in objects.keys():
            ...
            img_down, img_side, loc0, loc1, loc2, loc3, y_max, y_min = Find_2d_box(True, pc, objects[i].boxes_origin[0].box,
                                                                                   calib.p2, None, detect_config,
            ...
            if loc2 is not None:
                if save_det_image == True:
                    cv2.imwrite("{:s}/{:.4f}_picture_{:s}_object_{:d}.png".format(image_save_path, 0, seq, i), img_down)
                ...
                CurrentObject.truncate = 0
                CurrentObject.occlusion = 0
                CurrentObject.corners = std_box_3d
                CurrentObject.boxes = objects[i].boxes_origin
